    ...
    <ul class="d-sidebar-menu">
        ...
        <li class="has_submenu {{ arrayMenu(['user.investmentplan', 'user.invest.log']) }}">
            ...
            <ul class="submenu">
                <li class="{{ singleMenu('user.investmentplan') }}">
                    <a href="{{ route('user.investmentplan') }}"><i data-feather="chevrons-right"></i></i>
                        {{ __('Investment Plans') }}</a>
                </li>
                <li class="{{ singleMenu('user.invest.log') }}">
                    <a href="{{ route('user.invest.log') }}"><i data-feather="chevrons-right"></i>
                        {{ __('Invest Log') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li class="has_submenu {{ arrayMenu(['user.deposit', 'user.deposit.log']) }}">
            ...
            <ul class="submenu">
                <li class="{{ singleMenu('user.deposit') }}">
                    <a href="{{ route('user.deposit') }}"><i data-feather="chevrons-right"></i>
                        {{ __('Deposit') }}</a>
                </li>
                <li class="{{ singleMenu('user.deposit.log') }}">
                    <a href="{{ route('user.deposit.log') }}"><i data-feather="chevrons-right"></i>
                        {{ __('Deposit Log') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li class="has_submenu {{ arrayMenu(['user.withdraw', 'user.withdraw.*']) }}">
            ...
            <ul class="submenu">
                ...
                <li class="{{ singleMenu('user.withdraw.*') }}">
                    <a href="{{ route('user.withdraw.all') }}"><i data-feather="chevrons-right"></i>
                        {{ __('Withdraw Log') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li class="{{ singleMenu('user.transaction.log') }}">
            <a href="{{ route('user.transaction.log') }}"><i data-feather="file-text"></i>
                {{ __('Transaction Log') }}</a>
        </li>
