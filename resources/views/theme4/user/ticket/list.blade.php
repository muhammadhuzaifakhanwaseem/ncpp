                    ...
                    <div class="col-md-8 text-md-start text-center"> 
                        <div class="tab-btn-group mt-5"> 
                            <a href="{{ route('user.ticket.index') }}"
                                class="tab-btn m-2 {{ request()->status == '' ? 'active' : '' }}"><i class="fa fa-inbox fa-lg"
                                    aria-hidden="true"></i>
                                {{ __('All Ticket') }} <span class="num">{{ $tickets_all }}</span>
                            </a>
                            <a href="{{ route('user.ticket.status', 'answered') }}"
                                class="tab-btn m-2 {{ request()->status == 'answered' ? 'active' : '' }}">{{ __('Answered') }}
                                <span class="num">{{ $tickets_answered }}</span>
                            </a>
                            <a href="{{ route('user.ticket.status', 'pending') }}"
                                class="tab-btn m-2 {{ request()->status == 'pending' ? 'active' : '' }}">
                                {{ __('Pending') }} <span class="num">{{ $tickets_pending }}</span>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4  text-md-end text-center">
                        <button id="new-ticket" class="btn main-btn btn-sm"><span>{{ __('Create Ticket') }} <i class="fa fa-envelope"
                ...
                <div class="modal-content bg-body">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn main-btn"><span>{{ 'Create Ticket' }}</span></button>
                        </div>
                    </div>
                </div>
            </form>
                    ...
                    <div class="modal-content bg-body">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
                                    data-bs-dismiss="modal">{{ __('Close') }}</button>
                                <button type="submit" class="btn main-btn"><span>{{ 'Update Ticket' }}</span></button>
                            </div>
                        </div>
                    </div>
                </form>
