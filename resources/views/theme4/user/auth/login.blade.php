    ...
    <div class="align-self-center">
        <div class="row align-items-center justify-content-center vh-100">
            <div class="col-10 col-sm-8 col-md-6 col-lg-3 text-center text-white py-3">
                ...
                <p class="text-white"><a href="{{ route('user.register') }}" class="text-white">Create an account</a>
                </p>
                ...
                <div class=" mt-auto mb-4 text-center d-grid">
                    ...
                    <p class="text-white"><a href="{{ route('user.forgot.password') }}" class="text-white">Forgot your
                            password?
                            clicking
                            here</a>
                    </p>
