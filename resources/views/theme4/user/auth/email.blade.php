...
@section('content')
    ...
    <form action="" class="row h-100 justify-content-center reg-form" autocomplete="off" method="POST">
        @csrf
        <input type="hidden" name="email" value="">
        ...
        <div class="col-12 align-self-center">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 text-center text-white">
                    <h3 class="mb-3 mb-lg-4">{{ __('Request For Reset Password') }}</h3>
                    ...
                    <p class="text-white"><a href="{{ route('user.login') }}" class="text-white">Return to login</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 mt-auto mb-4 text-center d-grid">
            <!-- submit button -->
            <button class="btn btn-lg btn-theme z-index-5 mb-4" type="submit">{{ __('Verify Now') }}<i
