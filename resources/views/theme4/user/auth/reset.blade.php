...
@section('content')
    ...
    <form action="{{ route('user.reset.password') }}" class="row h-100 justify-content-center" autocomplete="off"
        method="POST">
        @csrf
        <input type="hidden" name="email" value="{{ $session['email'] }}">
        ...
        <div class="col-12 align-self-center">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 text-center text-white">
                    <h3 class="mb-3 mb-lg-4">Reset password</h3>
                        ...
                        <div class="form-group mb-2 position-relative check-valid text-dark">
                            <div class="input-group input-group-lg">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control border-start-0" id="default-01"
        ...
        <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 mt-auto mb-4 text-center d-grid">
            <!-- submit button -->
            <button class="btn btn-lg btn-theme z-index-5 mb-4" type="submit" id="recaptcha">Reset password <i
                    class="bi bi-arrow-right"></i></button>
            <p class="text-white"><a href="{{ route('user.login') }}" class="text-white">Return to login</a></p>
        </div>
    </form>
@endsection
