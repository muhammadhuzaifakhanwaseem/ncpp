                                            ...
                                            <div class="card-body">
                                                ...
                                                @if ($data['user']->loginSecurity == null)
                                                    <form class="form-horizontal" method="POST"
                                                        action="{{ route('user.generate2faSecret') }}">
                                                        {{ csrf_field() }}
                                                ...
                                                @elseif(!$data['user']->loginSecurity->google2fa_enable)
                                                    ...
                                                    <form class="form-horizontal" method="POST"
                                                        action="{{ route('user.enable2fa') }}">
                                                        {{ csrf_field() }}
                                                        <div
                                                            class="form-group{{ $errors->has('verify-code') ? ' has-error' : '' }}">
                                                            <label for="secret"
                                                                class="control-label">{{ __('Authenticator Code') }}</label>
                                                ...
                                                @elseif($data['user']->loginSecurity->google2fa_enable)
                                                    ...
                                                    <form class="form-horizontal" method="POST"
                                                        ...
                                                        <button type="submit"
                                                            class="btn main-btn mt-4"><span>{{ __('Disable 2FA') }}</span></button>
                                                    </form>
                                                @endif
                                            </div>
                                        </div>
