                    ...
                    <div class="col-md-8 text-md-start text-center"> 
                        <div class="tab-btn-group mt-5"> 
                            <a href="<?php echo e(route('user.ticket.index')); ?>"
                                class="tab-btn m-2 <?php echo e(request()->status == '' ? 'active' : ''); ?>"><i class="fa fa-inbox fa-lg"
                                    aria-hidden="true"></i>
                                <?php echo e(__('All Ticket')); ?> <span class="num"><?php echo e($tickets_all); ?></span>
                            </a>
                            <a href="<?php echo e(route('user.ticket.status', 'answered')); ?>"
                                class="tab-btn m-2 <?php echo e(request()->status == 'answered' ? 'active' : ''); ?>"><?php echo e(__('Answered')); ?>

                                <span class="num"><?php echo e($tickets_answered); ?></span>
                            </a>
                            <a href="<?php echo e(route('user.ticket.status', 'pending')); ?>"
                                class="tab-btn m-2 <?php echo e(request()->status == 'pending' ? 'active' : ''); ?>">
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\quantum-trade\resources\views/theme4/user/ticket/list.blade.php ENDPATH**/ ?>