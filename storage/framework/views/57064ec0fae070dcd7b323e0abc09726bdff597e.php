                                            ...
                                            <div class="card-body">
                                                ...
                                                <?php if($data['user']->loginSecurity == null): ?>
                                                    <form class="form-horizontal" method="POST"
                                                        action="<?php echo e(route('user.generate2faSecret')); ?>">
                                                ...
                                                <?php elseif(!$data['user']->loginSecurity->google2fa_enable): ?>
                                                    ...
                                                    <form class="form-horizontal" method="POST"
                                                        action="<?php echo e(route('user.enable2fa')); ?>">
                                                        <?php echo e(csrf_field()); ?>

                                                        <div
                                                            class="form-group<?php echo e($errors->has('verify-code') ? ' has-error' : ''); ?>">
                                                            <label for="secret"
                                                                class="control-label"><?php echo e(__('Authenticator Code')); ?></label>
                                                            <input id="secret" type="password"
                                                                class="form-control col-md-12 mb-3" name="secret" required>
                                                ...
                                                <?php elseif($data['user']->loginSecurity->google2fa_enable): ?>
                                                    ...
                                                    <form class="form-horizontal" method="POST"
                                                        action="<?php echo e(route('user.disable2fa')); ?>">
                                                        <?php echo e(csrf_field()); ?>
                                                        ...
                                                        <div
                                                            ...
                                                            <input id="current-password" type="password"
                                                                class="form-control col-md-12 mb-4" name="current-password"
                                                                required>
                                                        ...
                                                        <button type="submit"
                                                            class="btn main-btn mt-4"><span><?php echo e(__('Disable 2FA')); ?></span></button>
                                                    </form>
                                                <?php endif; ?>
                                            </div>
                                        </div>
