...
<head>
    ...
    <!-- chosen css -->
    <link rel="stylesheet"
        href="<?php echo e(asset('asset/theme4/dashboard_assets/assets/vendor/chosen_v1.8.7/chosen.min.css')); ?>">

    <!-- date range picker -->
    <link rel="stylesheet"
        href="<?php echo e(asset('asset/theme4/dashboard_assets/assets/vendor/daterangepicker/daterangepicker.css')); ?>">
    ...
    <!-- simple lightbox css -->
    <link rel="stylesheet"
        href="<?php echo e(asset('asset/theme4/dashboard_assets/assets/vendor/simplelightbox/simple-lightbox.min.css')); ?>">

    <!-- app tour css -->
    <link href="https://cdn.jsdelivr.net/npm/@sweetalert2/theme-dark@4/dark.css" rel="stylesheet">

    <link rel="stylesheet"
        href="<?php echo e(asset('asset/theme4/dashboard_assets/assets/vendor/Product-Tour-Plugin-jQuery/lib.css')); ?>">

    <!-- Footable table master css -->
    <link rel="stylesheet"
        href="<?php echo e(asset('asset/theme4/dashboard_assets/assets/vendor/fooTable/css/footable.bootstrap.min.css')); ?>">

    <!-- style css for this template -->
    <link href="<?php echo e(asset('asset/theme4/dashboard_assets/assets/scss/style.css')); ?>" rel="stylesheet">
...
<body class="d-flex flex-column h-100 sidebar-pushcontent sidebar-filled" data-sidebarstyle="sidebar-pushcontent">
        ...
        <nav class="navbar fixed-top">
            <div class="container-fluid">
                ...
                <div class="ms-auto">
                    <div class="row">
                        <div class="col-auto">
                            <a href="https://wa.me/<?php echo e($general->whatsapp_number); ?>" type="button"
                                ...
                                <a class="dd-arrow-none dropdown-toggle" id="userprofiledd" data-bs-toggle="dropdown"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col ps-0 align-self-center d-none d-lg-block">
                                            <p class="mb-0">
                                                <span
                                                    class="text-white username"><?php echo e(@Auth::user()->fname . ' ' . @Auth::user()->fname); ?></span><br>
                                            </p>
                                        </div>
                                        <div class="col ps-0 align-self-center d-none d-lg-block">
                                        ...
                                        <div class="row">
                                            <div class="col-auto">
                                                <figure class="avatar avatar-50 rounded-circle coverimg vm">
                                                    <img id="file-id-preview"
                                                        src="<?php echo e(getFile('user', @Auth::user()->image)); ?>"
                                                        alt="pp" />
                                                </figure>
                                            </div>
                                            <div class="col align-self-center ps-0">
                                                <h6 class="mb-0"><span
                                                        class="username"><?php echo e(@Auth::user()->fname . ' ' . @Auth::user()->fname); ?></span>
                                                </h6>
                                                <p class="text-muted small">Balance:
                                                    <?php echo e(number_format(auth()->user()->balance, 2)); ?> </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div><a class="dropdown-item" href="<?php echo e(url('profile/setting')); ?>">My Profile</a>
                                    </div>
                                    <div>
                                        <div><a class="dropdown-item" href="<?php echo e(url('2fa')); ?>">2FA</a>
                                        </div>
                                        <div><a class="dropdown-item" href="<?php echo e(url('/logout')); ?>">Logout</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row text-center collapse " id="usersidebarprofile">
                    <div class="col-12">
                        <div class="avatar avatar-100 rounded-circle shadow-sm mb-3 bg-white">
                            <figure class="avatar avatar-90 rounded-circle coverimg">
                                <img id="file-id-preview" src="<?php echo e(getFile('user', @Auth::user()->image)); ?>"
                                    alt="pp" />
                            </figure>
                        </div>
                    </div>
                    <div class="col-12 mb-4">
                        <h6 class="mb-1" id="usernamedisplay">
                            <?php echo e(@Auth::user()->fname . ' ' . @Auth::user()->fname); ?></h6>
                    </div>
                </div>
                        ...
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item nav-link" href="<?php echo e(url('investmentplan')); ?>">
                                    ...
                                    <li>
                                        <a class="dropdown-item nav-link" href="<?php echo e(url('invest/log')); ?>">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item nav-link" href="<?php echo e(url('deposit')); ?>">
                                    ...
                                    <li>
                                        <a class="dropdown-item nav-link" href="<?php echo e(url('deposit/log')); ?>">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item nav-link" href="<?php echo e(url('withdraw')); ?>">
                                    ...
                                    <li>
                                        <a class="dropdown-item nav-link" href="<?php echo e(url('withdraw/all')); ?>">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="<?php echo e(url('my/reward')); ?>">
                                    <div class="avatar avatar-40 icon"><i class="bi bi-house-door"></i></div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="<?php echo e(url('transaction/log')); ?>">
                                    <div class="avatar avatar-40 icon"><i class="bi bi-house-door"></i></div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="<?php echo e(url('commision')); ?>">
                                    <div class="avatar avatar-40 icon"><i class="bi bi-house-door"></i></div>
    ...
    <main class="main mainheight container pt-5" style="width: -webkit-fill-available;">
        <div class="py-2 px-3 d-xl-none d-lg-none d-flex justify-content-between position-fixed top-0 w-100 z-index-2 start-0 align-items-center" style="backdrop-filter: blur(20px); background: #49494966;">
            ...
            <div class="position-fixed text-center" style="right: 10px; bottom: 70px;">
                ...
                <a target="_blank" href="https://wa.me/<?php echo e($general->whatsapp_number); ?>" style="display: inline-flex; flex-direction: column; align-items: center; text-decoration: none;">
    ...
    <!-- date range picker -->
    <script src="<?php echo e(asset('asset/theme4/dashboard_assets/cdns/momentjs/latest/moment.min.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/theme4/dashboard_assets/assets/vendor/daterangepicker/daterangepicker.js')); ?>"></script>

    <!-- chosen script -->
    <script src="<?php echo e(asset('asset/theme4/dashboard_assets/assets/vendor/chosen_v1.8.7/chosen.jquery.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('asset/theme4/dashboard_assets/assets/vendor/simplelightbox/simple-lightbox.jquery.min.js')); ?>">
    </script>

    <!-- app tour script-->
    <script src="<?php echo e(asset('asset/theme4/dashboard_assets/assets/vendor/Product-Tour-Plugin-jQuery/lib.js')); ?>"></script>

    <!-- Footable table master script-->
    <script src="<?php echo e(asset('asset/theme4/dashboard_assets/assets/vendor/fooTable/js/footable.min.js')); ?>"></script>

    <!-- page level script here -->
    <script src="<?php echo e(asset('asset/theme4/dashboard_assets/assets/js/header-title.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/theme4/dashboard_assets/assets/js/finance-wallet.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\ncpp\resources\views/theme4/layout/master2.blade.php ENDPATH**/ ?>