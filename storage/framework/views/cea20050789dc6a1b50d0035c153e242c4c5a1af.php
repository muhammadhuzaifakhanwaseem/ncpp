        ...
        <div class="components-preview px-2">
            <div class="nk-block-head nk-block-head-lg wide-sm">
                <div class="card-header">
                    <h5 class="mb-sm-0 mb-2 mt-2 text-white"><?php echo e(__('Refferal Log')); ?></h5>
                    <form action="" method="get" class="">
                        <input type="text" name="trx" class="form-control form-control-sm rounded-0 bg-transparent text-white border border-light my-3 py-2"
