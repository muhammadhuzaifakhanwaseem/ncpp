                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('Active Users Required VIP 1')); ?></label>
                                        <div class="input-group">
                                            <input type="number" name="act_user_req_1" placeholder="<?php echo app('translator')->get('Active Users Required VIP 1'); ?>"
                                               value="<?php echo e($general->req_active_users_vip1); ?>" class="form-control form_control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('Active Users Required VIP 2')); ?></label>
                                        <div class="input-group">
                                            <input type="number" name="act_user_req_2" placeholder="<?php echo app('translator')->get('Active Users Required VIP 2'); ?>"
                                               value="<?php echo e($general->req_active_users_vip2); ?>" class="form-control form_control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('Active Users Required VIP 3')); ?></label>
                                        <div class="input-group">
                                            <input type="number" name="act_user_req_3" placeholder="<?php echo app('translator')->get('Active Users Required VIP 3'); ?>"
                                               value="<?php echo e($general->req_active_users_vip3); ?>" class="form-control form_control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('Active Users Required VIP 4')); ?></label>
                                        <div class="input-group">
                                            <input type="number" name="act_user_req_4" placeholder="<?php echo app('translator')->get('Active Users Required VIP 4'); ?>"
                                               value="<?php echo e($general->req_active_users_vip4); ?>" class="form-control form_control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('Active Users Required VIP 5')); ?></label>
                                        <div class="input-group">
                                            <input type="number" name="act_user_req_5" placeholder="<?php echo app('translator')->get('Active Users Required VIP 5'); ?>"
                                               value="<?php echo e($general->req_active_users_vip5); ?>" class="form-control form_control">
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('VIP 1 Reward Amount')); ?></label>
                                        <div class="input-group">
                                            <input type="text" name="vip1_rwd_limit" placeholder="<?php echo app('translator')->get('VIP 1 Reward Amount'); ?>"
                                               value="<?php echo e($general->vip1_reward_amount); ?>" class="form-control form_control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('VIP 2 Reward Amount')); ?></label>
                                        <div class="input-group">
                                            <input type="text" name="vip2_rwd_limit" placeholder="<?php echo app('translator')->get('VIP 2 Reward Amount'); ?>"
                                               value="<?php echo e($general->vip2_reward_amount); ?>" class="form-control form_control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('VIP 3 Reward Amount')); ?></label>
                                        <div class="input-group">
                                            <input type="text" name="vip3_rwd_limit" placeholder="<?php echo app('translator')->get('VIP 3 Reward Amount'); ?>"
                                               value="<?php echo e($general->vip3_reward_amount); ?>" class="form-control form_control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('VIP 4 Reward Amount')); ?></label>
                                        <div class="input-group">
                                            <input type="text" name="vip4_rwd_limit" placeholder="<?php echo app('translator')->get('VIP 4 Reward Amount'); ?>"
                                               value="<?php echo e($general->vip4_reward_amount); ?>" class="form-control form_control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('VIP 5 Reward Amount')); ?></label>
                                        <div class="input-group">
                                            <input type="text" name="vip5_rwd_limit" placeholder="<?php echo app('translator')->get('VIP 5 Reward Amount'); ?>"
                                               value="<?php echo e($general->vip5_reward_amount); ?>" class="form-control form_control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <select name="vip_reward_status" class="form-control form_control">
                                                <option value="0" <?php echo e($general->is_vip_reward == 0 ? 'selected' : ''); ?>>Deactive</option>
                                                <option value="1" <?php echo e($general->is_vip_reward == 1 ? 'selected' : ''); ?>>Active</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="mt-3"><?php echo e(__('Whatsapp number')); ?></label>
                                        <div class="input-group">
                                            <input type="number" name="whatsapp_number" placeholder="<?php echo app('translator')->get('Whatsapp Number'); ?>"
                                               value="<?php echo e($general->whatsapp_number); ?>" class="form-control form_control">
                                        </div>
                                    </div>
