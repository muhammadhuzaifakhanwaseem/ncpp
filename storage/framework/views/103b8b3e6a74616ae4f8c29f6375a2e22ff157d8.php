                    ...
                    <div class="components-preview px-2">
                        <div class="nk-block-head nk-block-head-lg wide-sm">
                            <div class="card-header my-3 d-flex flex-wrap justify-content-between align-items-center">
                                <h5 class="title text-white p-0 m-0"><?php echo e(__('Authentication')); ?></h5>
                                
                                <a href="<?php echo e(route('user.change.password')); ?>" class="cmn-btn p-0 m-0 text-white"><i
                                        ...
                                        <div class="row gy-4 justify-content-center">
                                            ...
                                            <div class="col-md-8 p-0">
                                                ...
                                                <button class=" btn bg-yello-green fw-bold w-100"><span
                                                        class=""><?php echo e(__('Update')); ?></span></button>
                                            </div>
                                    </form>
                                </div>
                            </div>
