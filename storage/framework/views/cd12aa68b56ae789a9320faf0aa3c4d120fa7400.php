        ...
        <div class="container col-lg-6">
            <div class="components-preview px-2">
                <div class="card-header">
                    <h5 class="mb-sm-0 mb-2 mt-2 text-white"><?php echo e(__('Deposit Log')); ?></h5>
                    <form action="" method="get" class="">
                        <input type="text" name="trx"
                            class="form-control form-control-sm bg-transparent border border-light rounded-0 py-2 my-3"
            ...
            <div class="cards-main">
                                    ...
                                    <table>
                                        ...
                                        <tr class="service">
                                            ...
                                            <td>
                                                ...
                                                <?php elseif(@$transaction->payment_status == 3): ?>
                                                    <p class="itemtext">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <h6 class="text-white my-3">NO INVESTMENT FOUND</h6>
                <?php endif; ?>
            </div>
        </div>
    </div>
