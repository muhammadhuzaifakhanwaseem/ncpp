...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label class="font-weight-bold"><?php echo e(__('Vip Status')); ?></label>
                                        <select name="vip_status" class="form-control selectric">
                                            <option value="" selected disabled><?php echo e(__('Select Vip Status')); ?></option>
                                            ...
                                            <option value="4"><?php echo e(__('Vip 4')); ?></option>
                                            <option value="5"><?php echo e(__('Vip 5')); ?></option>
                                        </select>
                                    </div>
