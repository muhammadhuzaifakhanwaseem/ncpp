...
<form action="<?php echo e(route('user.update.password')); ?>" class="row h-100 justify-content-center" autocomplete="off"
    method="POST">
    <?php echo csrf_field(); ?>
    <div class="col-12 align-self-center">
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 text-center text-white">
                <h3 class="mb-3 mb-lg-4 text-white fw-bold"><?php echo e(__('Old Password')); ?></h3>
                    ...
                    <div class="form-group mb-2 position-relative check-valid text-dark">
                        <div class="input-group input-group-lg">
                            ...
                            <div class="form-floating">
                                ...
                                placeholder="<?php echo e(__('Confirm Password')); ?>" type="password"
                                name="password_confirmation">
                                <label class="text-white" for="password"><?php echo e(__('Confirm Password')); ?></label>
                            </div>
                            <span class="input-group-text text-white bg-transparent  border-end-0" id="viewpassword"><i
                                    class="bi bi-eye"></i></span>
                        </div>
    ...
    <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 mt-auto mb-4 text-center d-grid">
        <!-- submit button -->
        <button class="btn btn-lg bg-yello-green  z-index-5 mb-4" type="submit"><?php echo e(__('Update')); ?><i
