...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card mb-4 bg-theme" style="border-radius: 0px 100px 0px 0px;border-right: 4px solid #fff;">
                <div class="card-body px-lg-4 px-xl-5 bg-none">
                    <div class="text-center mb-4">
                        <span class="text-white display-2 text-center fw-bold">Best</span>
                    </div>
                    <div class="row mb-4 px-5">
                        <!-- <div class="col-auto">
                             <i
                                class="avatar avatar-50 rounded-circle bg-light-white text-white h5 bi bi-building vm"></i>
                        </div> -->
                        <div class="col">
                    ...
                    <div class="row align-items-center mb-4 px-5">
                        <div class="col-auto">
                    ...
                    <h6 class="px-5">Basic includes:</h6>
                    <ul class="list-group list-group-flush bg-none no-border px-5">
...
<?php $__env->startPush('script'); ?>
    <div class="modal mt-5
        ...
        <div class="modal-dialog" role="document" style="box-shadow: 6px 7px 13px 0px rgba(0,0,0,0.75)!important;">
            <form class="invest-form" style="width: 100%;" action="<?php echo e(route('user.investmentplan.submit')); ?>" method="post">
                <?php echo csrf_field(); ?>
